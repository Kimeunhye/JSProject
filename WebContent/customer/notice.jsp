			...
			<div class="top-wrapper clear">
				...
				/* 		List<Notice> list = (List)request.getAttribute("list");
						...
						<tr>
								...
								<td class="title"><a href="noticeDetail.jsp?c=${n.code}">${n.title}</a><span>${n.cmtCnt}</span></td>
					...
					<%-- <p>
						<c:forTokens var="n" items="26,45,35,25,15" delims=","> //delims의 쉼표를 기준으로 item을 나눈다.
						${n+1}/
						</c:forTokens>
					</p> --%>
					...
					<div id="pager-wrapper" class="margin-small">
						<div class="pager clear">
							...
							<ul>
								<li>
									<a class="strong" href="notice?f=${param.f}&q=${param.q}&pg=1">1</a>
								</li>
								<li>
									<a class="strong" href="notice?f=${param.f}&q=${param.q}&pg=2">2</a>
								</li>
								<li>
									<a class="strong" href="notice?f=${param.f}&q=${param.q}&pg=3">3</a>
								</li>
								<li>
									<a class="strong" href="notice?f=${param.f}&q=${param.q}&pg=4">4</a>
								</li>
								<li>
									<a class="strong" href="notice?f=${param.f}&q=${param.q}&pg=5">5</a>
								</li>
							</ul>
							<p id="btnNext">
